...
export function calculateFilterPosition(type:string,keypoints:Keypoint[]) {
...
function calculateMouthFilterPosition(keypoints:Keypoint[]) {
...
function calculateFaceOutlineFilterPosition(keypoints:Keypoint[]) {
    // 얼굴의 좌우, 상하를 정의하는 좌표
...
function calculateLeftEyeFilterPosition(keypoints:Keypoint[]){
    const xPadding = 40;
    const yPadding = -30;
...
function calculateForeHeadBaldFilterPosition(keypoints:Keypoint[]) {
...
function calculateBaldFilterPosition(keypoints:Keypoint[]){
...
function calculateEyeFilterPosition(keypoints:Keypoint[]) {
...
//   return { x, y, width, height, angle };
// }
function calculateNoseFilterPosition(keypoints:Keypoint[]){
    const xPadding = 20;
    const yPadding = 20;
...
function calculateFaceFilterPosition(keypoints:Keypoint[]) {
